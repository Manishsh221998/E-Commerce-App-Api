...
const sendEmailCredentials = async (user, password) => {
  try {
    ...
    const info = await transporter.sendMail({
      ...
      to: user.email,
      subject: "Your Login Credentials - E-Commerce Platform",
      text: `Welcome to E-Commerce Platform\n\nLogin Credentials:\nName: ${user.name}\nRole: ${roleName}\nEmail: ${user.email}\nPassword: ${password}\n\nPlease login and change your password immediately.`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
          <h2 style="color: #4CAF50;">Welcome to E-Commerce Platform, ${user.name}!</h2>
          ...
          <p style="font-size: 12px; color: #888;">This email was sent to ${user.email} as part of your registration on E-Commerce Platform.</p>
        </div>
      `,
    });
